...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('records_record', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='records_created', to=orm['profiles.Profile'])),
            ('other_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='records_fulfilled', null=True, to=orm['profiles.Profile'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('picture', self.gf('django.db.models.fields.files.ImageField')(default='/static/placeholder.jpg', max_length=100, blank=True)),
        ...
        # Adding model 'Wish'
        db.create_table('records_wish', (
            ('record', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['records.Record'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('records', ['Wish'])

        # Adding model 'Gift'
        db.create_table('records_gift', (
            ('record', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['records.Record'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('records', ['Gift'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Wish'
        db.delete_table('records_wish')

        # Deleting model 'Gift'
        db.delete_table('records_gift')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Record.is_featured'
        db.add_column('records_record', 'is_featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Record.is_featured'
        db.delete_column('records_record', 'is_featured')
